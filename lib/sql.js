...
function getFilter (object) {
  return 'limit' in object && object.limit && typeof object.limit === 'number'
    ? `LIMIT ${object.limit} ${'offset' in object && object.offset && typeof object.offset === 'number' ? `OFFSET ${object.offset}` : null}`
    : null
}
